...
const NOVIDADES: Produto[] = [
  {
    ...
    descLonga:
      "Conjunto de sutiã e calcinha em renda floral importada, com forro suave e detalhes em laço de cetim. Modelagem que valoriza as curvas com elegância e conforto durante todo o dia.",
    preco: 189.9,
    precoAntigo: 249.9,
    tamanhos: ["P", "M", "G", "GG"],
    detalhes: ["Renda floral importada", "Forro em microfibra", "Laços de cetim", "Bojo removível"],
    imagem:
      "https://images.unsplash.com/photo-1575186083127-03641b958f61?w=900&h=900&fit=crop&q=80",
  },
  {
    id: 2,
    ...
    descLonga:
      "Body em veludo bordô com toque aveludado e caimento impecável. Decote em V profundo e fechamento inferior em botões de pressão para máximo conforto e praticidade.",
    preco: 159.9,
    tamanhos: ["P", "M", "G"],
    detalhes: ["Veludo premium", "Decote em V", "Fechamento em pressão", "Alças reguláveis"],
    imagem:
      "https://images.unsplash.com/photo-1642945680515-faada4c0ca7b?w=900&h=900&fit=crop&q=80",
  },
  {
    id: 3,
    ...
    descLonga:
      "Camisola em seda natural com acabamento em renda italiana e comprimento midi. Toque fresco e caimento fluido, perfeita para noites especiais ou momentos de relaxamento.",
    preco: 229.9,
    tamanhos: ["P", "M", "G"],
    detalhes: ["100% seda natural", "Renda italiana", "Comprimento midi", "Alças finas reguláveis"],
    imagem:
      "https://images.unsplash.com/photo-1767972463565-5a9387059b01?w=900&h=900&fit=crop&q=80",
  },
  {
    id: 4,
    ...
    descLonga:
      "Conjunto sofisticado com aplicações de strass feitas à mão, peça única para ocasiões especiais. Brilho refinado e modelagem que esculpe a silhueta com glamour.",
    preco: 279.9,
    precoAntigo: 329.9,
    tamanhos: ["P", "M", "G"],
    detalhes: ["Strass aplicado à mão", "Edição limitada", "Tule e renda", "Acabamento premium"],
    imagem:
      "https://images.unsplash.com/photo-1625023489823-c9c1e36d6f2b?w=900&h=900&fit=crop&q=80",
  },
  {
    id: 5,
    ...
    descLonga:
      "Sutiã push-up com espuma anatômica que valoriza o colo naturalmente. Aros revestidos, alças reguláveis e tecido respirável para conforto o dia inteiro.",
    preco: 89.9,
    tamanhos: ["P", "M", "G", "GG"],
    detalhes: [
      "Espuma push-up anatômica",
      "Aros revestidos",
      "Tecido respirável",
      "Fecho de 3 ganchos",
    ],
    imagem:
      "https://images.unsplash.com/photo-1583900985737-6d0495555783?w=900&h=900&fit=crop&q=80",
  },
  {
    id: 6,
    ...
    descLonga:
      "Calcinha em renda francesa importada com fita de cetim na cintura e acabamento delicado. Caimento confortável que veste como uma segunda pele.",
    preco: 49.9,
    tamanhos: ["P", "M", "G", "GG"],
    detalhes: [
      "Renda francesa importada",
      "Fita de cetim",
      "Forro de algodão",
      "Caimento confortável",
    ],
    imagem:
      "https://images.unsplash.com/photo-1585250047310-592b1805a8aa?w=900&h=900&fit=crop&q=80",
  },
];

const COLECAO = [
  {
    nome: "Primavera Sensual",
    itens: "18 peças",
    imagem:
      "https://images.unsplash.com/photo-1490481651871-ab68de25d43d?w=600&h=560&fit=crop&q=80",
  },
  {
    nome: "Noite de Veludo",
    itens: "12 peças",
    imagem:
      "https://images.unsplash.com/photo-1469334031218-e382a71b716b?w=600&h=560&fit=crop&q=80",
  },
  {
    nome: "Renda & Cetim",
    itens: "24 peças",
    imagem: "https://images.unsplash.com/photo-1550614000-4895a10e1bfd?w=600&h=560&fit=crop&q=80",
  },
  {
    nome: "Básicos Sofisticados",
    itens: "30 peças",
    imagem:
      "https://images.unsplash.com/photo-1617019114583-affb34d1b3cd?w=600&h=560&fit=crop&q=80",
  },
];
...
const LOOKBOOK = [
  {
    titulo: "Inverno Íntimo",
    sub: "Editorial 2026",
    imagem:
      "https://images.unsplash.com/photo-1509631179647-0177331693ae?w=600&h=680&fit=crop&q=80",
  },
  {
    titulo: "Noite & Desejo",
    sub: "Coleção Noturna",
    imagem:
      "https://images.unsplash.com/photo-1485968579580-b6d095142e6e?w=600&h=680&fit=crop&q=80",
  },
  {
    titulo: "Seda & Rendas",
    sub: "Look Premium",
    imagem:
      "https://images.unsplash.com/photo-1572804013427-4d7ca7268217?w=600&h=680&fit=crop&q=80",
  },
  {
    titulo: "Veludo Bordô",
    sub: "Edição Limitada",
    imagem:
      "https://images.unsplash.com/photo-1508214751196-bcfd4ca60f91?w=600&h=680&fit=crop&q=80",
  },
];
  ...
  return (
    <div className="min-h-dvh bg-background text-foreground antialiased">
      ...
      <section className="mx-auto max-w-6xl px-5 pb-24 pt-20 text-center sm:px-8 sm:pt-28">
        <span
          data-reveal
          className="mb-6 inline-flex items-center rounded-full bg-primary/10 px-4 py-1.5 text-[0.65rem] font-semibold uppercase tracking-[0.28em] text-primary"
        >
          Outono · Inverno 2026
        </span>
        <h1
          data-reveal
          data-delay="1"
          className="mx-auto max-w-3xl font-serif text-5xl font-light leading-[1.05] tracking-tight sm:text-7xl"
        >
        ...
        <p
          data-reveal
          data-delay="2"
          className="mx-auto mt-7 max-w-md text-base leading-relaxed text-muted-foreground"
        >
          Peças exclusivas que unem luxo, conforto e sensualidade — criadas para a mulher que sabe o
          que merece.
        </p>
        <div
          data-reveal
          ...
          {NOVIDADES.map((item, i) => (
            ...
            >
              ...
              <div className="p-5">
                ...
                <h3 className="mt-1.5 font-serif text-lg font-normal text-card-foreground">
                  {item.titulo}
                </h3>
            ...
            {COLECAO.map((col, i) => (
              ...
              >
                ...
                <div className="absolute inset-x-0 bottom-0 p-4 text-white">
                  <div className="text-[0.65rem] uppercase tracking-[0.18em] text-white/80">
                    {col.itens}
                  </div>
      ...
      <section id="tamanhos" className="mx-auto max-w-4xl px-5 py-24 sm:px-8">
        ...
        <p
          data-reveal
          className="mt-5 rounded-xl border border-border/60 bg-accent/40 p-4 text-center text-sm text-muted-foreground"
        >
          <span className="font-semibold text-primary">Dica:</span> em caso de dúvida entre dois
          tamanhos, opte pelo maior. Modelos em renda têm menos elasticidade.
        </p>
      </section>
      ...
      <section id="lookbook" className="border-t border-border bg-muted/40">
        <div className="mx-auto max-w-6xl px-5 py-24 sm:px-8">
            ...
            {LOOKBOOK.map((lk, i) => (
              ...
              >
                ...
                <div className="absolute inset-x-0 bottom-0 p-4 text-center text-white">
                  ...
                  <span className="text-[0.65rem] uppercase tracking-[0.18em] text-white/75">
                    {lk.sub}
                  </span>
                </div>
              </div>
          ...
          <div
            data-reveal
            className="mx-auto mt-16 max-w-xl rounded-3xl border border-border/60 bg-card p-10 text-center shadow-[var(--shadow-soft)]"
          >
            <span className="text-[0.6rem] font-semibold uppercase tracking-[0.3em] text-primary">
              Oferta especial
            </span>
            <h2 className="mt-3 font-serif text-3xl font-light text-card-foreground">
              15% OFF na primeira compra
            </h2>
            <p className="mx-auto mt-3 max-w-xs text-sm leading-relaxed text-muted-foreground">
              Use o cupom <strong className="text-primary">NOVIDADE15</strong> e ganhe 15% de
              desconto na sua primeira peça.
            </p>
    ...
    >
      ...
      >
        ...
        <div className="relative aspect-square w-full overflow-hidden bg-muted md:aspect-auto md:h-full">
          ...
          />
          <span className="absolute left-4 top-4 rounded-full bg-card/90 px-3 py-1 text-[0.6rem] font-semibold uppercase tracking-[0.14em] text-primary backdrop-blur">
            {produto.badge}
          </span>
        </div>
        ...
        <div className="flex flex-col gap-5 overflow-y-auto p-6 sm:p-8">
          <div>
            ...
            <h2 className="mt-1 font-serif text-2xl font-normal text-card-foreground sm:text-3xl">
              {produto.titulo}
            </h2>
          </div>
...
function SectionLabel({
  ...
  return (
    <div data-reveal className="mx-auto mb-14 max-w-md text-center">
      <span className="inline-flex items-center rounded-full bg-primary/10 px-3 py-1 text-[0.6rem] font-semibold uppercase tracking-[0.28em] text-primary">
        {eyebrow}
      </span>
